...
define('lyrics/tests/components/artist-item.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - components');
  QUnit.test('components/artist-item.js should pass jshint', function (assert) {
...
define('lyrics/tests/integration/components/artist-item-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {
  ...
  (0, _emberQunit.test)('it renders', function (assert) {
    ...
    this.render(Ember.HTMLBars.template((function () {
      return {
        ...
        statements: [['content', 'artist-item', ['loc', [null, [1, 0], [1, 15]]]]],
        locals: [],
        templates: []
      };
    })()));
...
define('lyrics/tests/integration/components/artist-item-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - integration/components');
  QUnit.test('integration/components/artist-item-test.js should pass jshint', function (assert) {
...
define('lyrics/tests/routes/index.jshint', ['exports'], function (exports) {
  'use strict';
...
define('lyrics/tests/unit/routes/random-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {

  (0, _emberQunit.moduleFor)('route:random', 'Unit | Route | random', {
    // Specify the other units that are required for this test.
    // needs: ['controller:foo']
  });
...
define('lyrics/tests/unit/routes/random-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - unit/routes');
  QUnit.test('unit/routes/random-test.js should pass jshint', function (assert) {
    assert.ok(true, 'unit/routes/random-test.js should pass jshint.');
  });
});
/* jshint ignore:start */
